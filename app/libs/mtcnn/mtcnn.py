...
class MTCNN(object):
    def __init__(self):
        ...
        self.refer = get_reference_facial_points(default_square=True)
    ...
    def run_rnet(self, bbox, image, size=24):
...
if __name__ == "__main__":
    ...
    while True:
        ...
        _, img = cap.read()
        b, l = mtcnn.predict(img)
        img = show_bboxes(img, b, l)
        print(1 / (time.time() - start_time))
        cv2.imshow('asdfa', img)
        cv2.waitKey(1)
